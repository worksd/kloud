...
export * as Community from './community.endpoint'
export * as Announcement from './announcement.endpoint'
export * as Voucher from './voucher.endpoint'
export * as TrackingEvent from './tracking.endpoint'
export * as Alimtalk from './alimtalk.endpoint'