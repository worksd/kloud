...
export const LessonGroupPaymentInfo = ({payment, url, appVersion, locale, beforeDepositor, actualPayerUserId}: {
    ...
    <div className={"flex flex-col"}>
      ...
      <div className="left-0 w-full fixed bottom-2 px-6">
        <PaymentButton
          ...
          selectedPass={selectedPass}
          selectedDiscounts={payment.discounts}
          type={{value: 'lessonGroup', prefix: 'LGT', apiValue: 'lesson-group'}}
          id={payment.lessonGroup?.id ?? 0}
          price={payment.totalPrice}
          title={payment.lessonGroup?.title ?? ''}
          user={payment.user}
          depositor={depositor}
          disabled={
            !selectedMethod ||
