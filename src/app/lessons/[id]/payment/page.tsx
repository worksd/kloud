        ...
        <div className="w-full h-screen bg-white px-6 flex flex-col pb-20 box-border overflow-auto">
            ...
            <div className="flex flex-col gap-y-16">
                ...
                <div className="flex gap-7">
                    <Image src={dummyData.thumbnailUrl} alt="수업 썸네일" width={86} height={114} className="rounded-lg h-[114px]" />

                    <div className="flex flex-col gap-2">
                        <p className="text-base font-bold text-left text-[#131517]">{dummyData.title}</p>
                        <p className="text-sm font-bold text-left text-[#505356]">
                            {dummyData.startTime} ({dummyData.duration}분간)
                        </p>
                        <p className="text-sm font-medium text-left text-[#505356]">
                ...
                <div className="w-[354px] text-center text-[#6b6e71] text-[10px] font-medium font-['Pretendard'] leading-[14px]">
