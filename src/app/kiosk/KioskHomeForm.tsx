...
export const KioskHomeForm = ({studioName, kioskImageUrl, locale, canCheckIn, canPurchase, onSelectPayment, onSelectVisit, onSelectLessonAttendance, onChangeLocale, onAdminMode}: KioskHomeFormProps) => {
  ...
  return (
    <div className="bg-white w-full h-screen flex flex-col overflow-hidden relative">
      ...
      {/* 카드 영역 — 수업 출석 체크(QR)는 항상 노출, 방문/결제는 canCheckIn/canPurchase 플래그에 따라 노출. */}
