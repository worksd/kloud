// 모바일(앱 웹뷰 / 좁은 웹) 결제 페이지 — 기존 payment/page.tsx 본문을 그대로 옮긴 폼.
// PC 웹은 PaymentPcForm 사용. 결제 로직(UnifiedPaymentInfo → payment.button)은 두 폼이 공유한다.
  ...
  return (
    <div className="relative w-full h-screen bg-white flex flex-col pb-20 box-border overflow-y-auto overscroll-none scrollbar-hide">
      <div className="flex flex-col">
        ...
        {/* bundle — 묶음 결제. 번들명 + 판매기간 + 구성 수업 리스트. */}
