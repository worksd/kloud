export const StringResource = {
  ...
  sns_transfer_warning_message: {
    ko: '이 SNS는 다른 계정에 연결되어 있어요.\n이 계정으로 가져오면 옛 계정에서는 이 SNS로 더 이상 로그인할 수 없어요.',
  ...
  sns_transfer_warning_bullet1: {
    ko: '옛 계정은 이 SNS로 로그인할 수 없게 돼요',
    en: 'The other account can no longer sign in with this SNS',
    jp: '以前のアカウントはこのSNSでログインできなくなります',
    zh: '原账户将无法再用此社交账户登录',
  },
  sns_transfer_warning_bullet2: {
    ko: '옛 계정의 결제·티켓 등 데이터는 옮겨지지 않고 그대로 남아요',
    en: 'Payments, tickets, and other data stay on the other account (not moved)',
    jp: '以前のアカウントの決済・チケットなどのデータは移されず、そのまま残ります',
    zh: '原账户的付款、票券等数据不会转移，将保留在原账户',
  },
