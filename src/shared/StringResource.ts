export const StringResource = {
  ...
  kiosk_check_in: { ko: '체크인', en: 'Check In', jp: 'チェックイン', zh: '签到' },
  kiosk_check_out: { ko: '체크아웃', en: 'Check Out', jp: 'チェックアウト', zh: '签退' },
  ...
  kiosk_select_lesson: { ko: '수업을 선택해주세요', en: 'Select a lesson', jp: 'レッスンを選択してください', zh: '请选择课程' },
  kiosk_select_pass_plan: { ko: '패스권을 선택해주세요', en: 'Select a pass', jp: '利用券を選択してください', zh: '请选择通票' },
  kiosk_select_promotion: { ko: '프로모션을 선택해주세요', en: 'Select a promotion', jp: 'プロモーションを選択してください', zh: '请选择促销' },
